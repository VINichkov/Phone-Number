class InputPhoneNumber extends React.Component{
    ...
    render(){
       return(
           <input id={this.state.id} onInput={this.handleInput} className={this.state.class_name} autofocus="autofocus" dataformat ={this.state.dataformat} value={this.state.value} placeholder={this.state.placeholder}></input>
       );
    }
}